...
See [streaming output](/commands/streaming) for long-running commands where you want to watch stdout as it happens, or [interactive sessions](/commands/sessions) when you need to write to a process's stdin while it runs.
