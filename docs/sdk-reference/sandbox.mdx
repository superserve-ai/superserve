...
| `pollIntervalMs` / `poll_interval_s` | `number`      | With `wait`, how often to check the status. TypeScript in milliseconds, Python in seconds. Default 1 second.        |
...
| `pollIntervalMs` / `poll_interval_s` | `number`      | How often to check the status while waiting. TypeScript in milliseconds, Python in seconds. Default 1 second.      |
