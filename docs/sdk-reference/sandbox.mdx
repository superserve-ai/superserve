...
| Option                               | Type          | Description                                                                                                        |
| ------------------------------------ | ------------- | ------------------------------------------------------------------------------------------------------------------ |
| `wait`                               | `boolean`     | Return once the sandbox is `paused` rather than once the pause is accepted. Default `false`.                       |
...
Restore a paused sandbox. A pause still in progress is waited out first. The backend rotates the per-sandbox access token; the SDK re-injects it into `sandbox.files` transparently.
