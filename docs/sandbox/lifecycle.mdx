...
You'll briefly see **`resuming`** while a paused sandbox is being restored to `active` - retry shortly. Deletion removes the sandbox entirely; further API calls return `404`.
