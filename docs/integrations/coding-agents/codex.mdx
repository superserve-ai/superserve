...
title: "Codex"
sidebarTitle: Codex
description: Run the OpenAI Codex CLI inside a Superserve sandbox.
---

Codex is OpenAI's terminal coding agent. Run it inside a Superserve sandbox so its shell commands and file edits stay isolated from your machine.
