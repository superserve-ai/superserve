...
<Tip>
A [reference implementation](https://github.com/superserve-ai/superserve/tree/main/guides/claude/dev-environment) with the orchestrator, runner, and setup scripts is available on GitHub in both Python and TypeScript.
</Tip>
...
See the [reference implementation](https://github.com/superserve-ai/superserve/tree/main/guides/claude/dev-environment) for the complete file.
...
<CardGroup cols={2}>
  ...
  <Card title="Reference implementation" href="https://github.com/superserve-ai/superserve/tree/main/guides/claude/dev-environment">
