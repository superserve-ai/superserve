...
<Tip>
A Python [reference implementation](https://github.com/superserve-ai/superserve/tree/main/guides/claude/claude-managed-agents) with the orchestrator, runner, and setup scripts is available on GitHub.
</Tip>
