...
<CardGroup cols={3}>
  <Card title="Research Agent" href="https://github.com/superserve-ai/superserve/tree/main/recipes/claude/research-agent">
  ...
  <Card title="Persistent Dev Environment" href="https://github.com/superserve-ai/superserve/tree/main/recipes/claude/dev-environment">
  ...
  <Card title="Parallel Benchmark Agent" href="https://github.com/superserve-ai/superserve/tree/main/recipes/claude/parallel-benchmark-agent">
