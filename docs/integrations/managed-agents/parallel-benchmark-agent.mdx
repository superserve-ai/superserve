...
<Tip>
A [reference implementation](https://github.com/superserve-ai/superserve/tree/main/recipes/claude/parallel-benchmark-agent) with the orchestrator, runner, and setup scripts is available on GitHub in both Python and TypeScript.
</Tip>
...
See the [reference implementation](https://github.com/superserve-ai/superserve/tree/main/recipes/claude/parallel-benchmark-agent) for the complete orchestrator file.
...
<CardGroup cols={2}>
  ...
  <Card title="Reference implementation" href="https://github.com/superserve-ai/superserve/tree/main/recipes/claude/parallel-benchmark-agent">
