...
Some credentials aren't API keys sent in HTTP headers - database URLs, signing secrets, or configuration tokens. For these, Superserve injects them as **environment variables** inside the microVM:
