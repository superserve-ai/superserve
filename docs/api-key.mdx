...
Go to [console.superserve.ai](https://console.superserve.ai?utm_source=docs&utm_medium=link), open **Settings &rarr; API keys**, and click **Create key**. Copy the value - it's only shown once.
