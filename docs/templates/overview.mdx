...
| `superserve/claude-code` | `superserve/node-22` | Claude Code CLI and `tmux` preinstalled. |
| `superserve/openclaw` | `superserve/node-22` | OpenClaw CLI and `tmux` preinstalled. |
| `superserve/hermes` | `superserve/node-22` | Hermes agent and `tmux` preinstalled. |
