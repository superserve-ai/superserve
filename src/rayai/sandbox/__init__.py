"""
RayAI Sandbox - Secure code execution in isolated containers.
...
Backend configuration:
    ...
    export RAYAI_SANDBOX_TEMPLATE=python-runtime-template  # K8s template
"""
...
__all__ = [
    ...
    "get_session_stats",
    "cleanup_session",
    # Tools (rayai.tool) - deprecated, use Sandbox instead
    "create_execute_python_tool",
    # Types
    "ExecutionResult",
    "ExecutionError",
