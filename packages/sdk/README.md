...
TypeScript SDK for the [Superserve](https://superserve.ai) sandbox API — Firecracker MicroVMs you can spin up, run commands in, and tear down from code. Generated by [Fern](https://buildwithfern.com).

Works in Node 18+, Bun, Deno, Cloudflare Workers, and modern browsers. ESM + CJS, no React dependency, no fetch polyfill.
...
Full docs: [superserve.docs.buildwithfern.com](https://superserve.docs.buildwithfern.com)
